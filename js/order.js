    ...
    var ShopOrderPage = ( function($) {
        ...
        ShopOrderPage.prototype.initUI = function() {
            ...
            function initUI($wrapper) {
                ...
                $('#js-order-page .wa-button.gray').removeClass('gray');
                $('.wa-order-form-wrapper .wa-step-confirm-section .wa-section-body .wa-actions-section .wa-button').addClass('bt button');
